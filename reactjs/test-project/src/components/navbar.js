    ...
    render(){
        ...
        return(
            ...
            <Navbar style={{height: 75}}>
                <div>
                {this.state.mobile === false && (<i style={{marginLeft: 25, marginRight: 5}} onClick={()=> this.setState({show : true})} className="fas fa-bars fa-lg" ></i>)}
